...
class test_default_instance_reader : public ::testing::Test {
protected:
	test_default_instance_reader() = default;

	~test_default_instance_reader() override;
...
test_default_instance_reader::~test_default_instance_reader() = default;

TEST_F(test_default_instance_reader, test_complete_records_path)
{
...
TEST_F(test_default_instance_reader, test_split_records_path)
{
	mlio::initialize();
	mlio::data_reader_params prm{};
...
TEST_F(test_default_instance_reader, test_corrupt_records_patH)
{
	mlio::initialize();
