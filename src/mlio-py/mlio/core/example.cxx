...
{
    py::class_<mlio::example, mlio::intrusive_ptr<mlio::example>>(
        m,
        "Example",
        ...
        .def("__getitem__",
             py::overload_cast<mlio::example &, std::string const &>(
                 &detail::get_feature))
        .def("__getitem__",
             py::overload_cast<mlio::example &, std::size_t>(
                 &detail::get_feature))
        .def("__contains__",
             [](mlio::example &self, std::string const &name) {
                 return self.get_schema().get_index(name) != std::nullopt;
             })
        .def("__contains__",
             [](mlio::example &self, std::size_t index) {
