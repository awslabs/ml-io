...
#if __cplusplus < 201703L && !defined(PYBIND11_HAS_EXP_OPTIONAL)

template<typename T>
struct type_caster<mlio::stdx::optional<T>> : optional_caster<mlio::stdx::optional<T>>
{};

template<>
struct type_caster<mlio::stdx::nullopt_t> : void_caster<mlio::stdx::nullopt_t>
{};

#endif

template<>
struct type_caster<mlio::stdx::string_view> : string_caster<mlio::stdx::string_view>
{};
