...
public:
    void
    operator()(mlio::log_level lvl, std::string_view msg) const
    {
        hdl_(lvl, msg);
    }
...
set_log_message_handler(py::function hdl)
{
    ...
    return mlio::set_log_message_handler(
        [py_hdl](mlio::log_level lvl, std::string_view msg) {
            py_hdl(lvl, msg);
        });
}
...
register_logging(py::module &m)
{
    ...
    m.def("set_log_message_handler",
          &detail::set_log_message_handler,
          "hdl"_a,
    ...
    m.def(
        "set_log_level", &mlio::set_log_level, "lvl"_a, "Sets the log level.");
}
