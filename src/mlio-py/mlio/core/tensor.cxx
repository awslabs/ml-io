...
make_dense_tensor(mlio::size_vector shape,
                  py::buffer &data,
                  std::optional<mlio::ssize_vector> strides,
                  bool cpy)
{
...
make_coo_tensor(mlio::size_vector shape,
                py::buffer &data,
...
register_tensors(py::module &m)
{
    ...
    py::class_<mlio::tensor, mlio::intrusive_ptr<mlio::tensor>>(m,
                                                                "Tensor",
                                                                R"(
        ...
        .def_property_readonly(
            "dtype", &mlio::tensor::dtype, "Gets the data type of the tensor.")
        .def_property_readonly(
            "shape",
            [](mlio::tensor &self) -> py::tuple {
    ...
    py::class_<mlio::dense_tensor,
        ...
        .def_property_readonly(
            "data",
            [](mlio::dense_tensor &self) {
                return py_device_array{mlio::wrap_intrusive(&self),
                                       self.data()};
            },
    ...
    py::class_<mlio::coo_tensor,
        ...
        .def(
            "indices",
            [](mlio::coo_tensor &self, std::size_t dim) {
                return py_device_array{mlio::wrap_intrusive(&self),
                                       self.indices(dim)};
            },
            "dim"_a,
