...
register_schema(py::module &m)
{
    py::class_<mlio::feature_desc>(m,
        ...
        .def_property_readonly("shape",
                               [](mlio::feature_desc &self) -> py::tuple {
    ...
    py::class_<mlio::schema, mlio::intrusive_ptr<mlio::schema>>(
        m,
        "Schema",
        ...
        .def("get_index",
             &mlio::schema::get_index,
             "name"_a,
             "Returns the index of the feature descriptor with the specified "
             "name in the descriptor list")
        .def("__eq__",
             [](mlio::schema const &self, mlio::schema const &other) {
                 return self == other;
             })
        .def("__hash__",
             [](mlio::schema const &self) {
